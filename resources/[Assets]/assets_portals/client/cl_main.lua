...
---				TriggerServerEvent("coke:leave")
 ---               DoScreenFadeOut(1)
 ---               Citizen.Wait(100)
---				SetEntityCoords(PlayerPedId(), 387.753, 3584.996, 33.29346)
---                DoScreenFadeIn(1000)
---                Citizen.Wait(1000)
 ----           end
---        
...
AddEventHandler('courthouse:exit', function()
	...
	TriggerEvent("dooranim")
	TriggerEvent('InteractSound_CL:PlayOnOne', 'DoorOpen', 0.8)
	SetEntityCoords(PlayerPedId(), 235.26019775391, -412.24730224609, 48.1111999511719)
...
AddEventHandler('courtroom:exit', function()
	...
	TriggerEvent("dooranim")
	TriggerEvent('InteractSound_CL:PlayOnOne', 'DoorOpen', 0.8)
	SetEntityCoords(PlayerPedId(), 249.17679016113, -364.7786428833008, -44.147630462646)
	SetEntityHeading(PlayerPedId(), 159.24726867676)
	DoScreenFadeIn(1000)
	Citizen.Wait(1000)
end)
...
AddEventHandler('weed:enter', function()
	...
	TriggerEvent("dooranim")
	TriggerEvent('InteractSound_CL:PlayOnOne', 'DoorOpen', 0.8)
	SetEntityCoords(PlayerPedId(), 1066.46, -3183.58, -39.16)
	SetEntityHeading(PlayerPedId(), 203.73556518555)
	DoScreenFadeIn(1000)
	Citizen.Wait(1000)
end)

RegisterNetEvent('weed:exit')
AddEventHandler('weed:exit', function()
	DoScreenFadeOut(1)
	Citizen.Wait(100)
	TriggerEvent("dooranim")
	TriggerEvent('InteractSound_CL:PlayOnOne', 'DoorOpen', 0.8)
	SetEntityCoords(PlayerPedId(), 1392.59, -2206.02, 61.46)
	SetEntityHeading(PlayerPedId(), 280.24726867676)
	DoScreenFadeIn(1000)
	Citizen.Wait(1000)
end)
...
RegisterNetEvent('cokeenter')
AddEventHandler('cokeenter', function()
	DoScreenFadeOut(1)
	Citizen.Wait(100)
	TriggerEvent("dooranim")
	TriggerEvent('InteractSound_CL:PlayOnOne', 'DoorOpen', 0.8)
	SetEntityCoords(PlayerPedId(), 1088.7, -3187.1, -38.99)
	SetEntityHeading(PlayerPedId(), 210.73556518555)
	DoScreenFadeIn(1000)
	Citizen.Wait(1000)
end)
...
AddEventHandler('coke:exit', function()
	...
	TriggerEvent("dooranim")
	TriggerEvent('InteractSound_CL:PlayOnOne', 'DoorOpen', 0.8)
	SetEntityCoords(PlayerPedId(), 3316.21, 5176.31, 18.46)
	SetEntityHeading(PlayerPedId(), 4.24726867676)
	DoScreenFadeIn(1000)
	Citizen.Wait(1000)
end)
...
RegisterNetEvent('recycleenter')
AddEventHandler('recycleenter', function()
	DoScreenFadeOut(1)
	Citizen.Wait(100)
	TriggerEvent("dooranim")
	TriggerEvent('InteractSound_CL:PlayOnOne', 'DoorOpen', 0.8)
	SetEntityCoords(PlayerPedId(), 992.62, -3097.76, -39.0)
	SetEntityHeading(PlayerPedId(), 210.73556518555)
	DoScreenFadeIn(1000)
	Citizen.Wait(1000)
end)
...
AddEventHandler('recycle:exit', function()
	...
	TriggerEvent("dooranim")
	TriggerEvent('InteractSound_CL:PlayOnOne', 'DoorOpen', 0.8)
	SetEntityCoords(PlayerPedId(), 578.7, -421.9, 24.73)
	SetEntityHeading(PlayerPedId(), 4.24726867676)
	DoScreenFadeIn(1000)
	Citizen.Wait(1000)
end)
...
RegisterNetEvent('roof1enter')
AddEventHandler('roof1enter', function()
	DoScreenFadeOut(1)
	Citizen.Wait(100)
	TriggerEvent("dooranim")
	TriggerEvent('InteractSound_CL:PlayOnOne', 'DoorOpen', 0.8)
	SetEntityCoords(PlayerPedId(), 964.3, 58.88, 112.55)
	SetEntityHeading(PlayerPedId(), 59.73556518555)
	DoScreenFadeIn(1000)
	Citizen.Wait(1000)
end)

RegisterNetEvent('roof1:exit')
AddEventHandler('roof1:exit', function()
	DoScreenFadeOut(1)
	Citizen.Wait(100)
	TriggerEvent("dooranim")
	TriggerEvent('InteractSound_CL:PlayOnOne', 'DoorOpen', 0.8)
	SetEntityCoords(PlayerPedId(), 1085.81, 214.77, -49.2)
	SetEntityHeading(PlayerPedId(), 313.66726867676)
	DoScreenFadeIn(1000)
	Citizen.Wait(1000)
end)
...
RegisterNetEvent("laundryenter")
AddEventHandler("laundryenter", function()
        TriggerEvent("DoLongHudText", "I gotta pat you down real quick.")
        Citizen.Wait(5000)
        for k,v in pairs(weapons) do
            if exports["srp-inventory"]:getQuantity(v) ~= 0 then
        ...
        if weapon == false then
        TriggerEvent("DoLongHudText", "Go Clean That Dirty Cash.")
            SetEntityCoords(PlayerPedId(), 1137.8633642578, -3198.3393457031, -39.676089782715)
            SetEntityHeading(PlayerPedId(), 14.41)
            DoScreenFadeIn(1000)
            Citizen.Wait(1000)
            elseif weapon == true then
            TriggerEvent("DoLongHudText", "We Won't Let You In Unless You Remove Those Weapons, Come Back When You Drop Them Off")
            weapon = false
        end
    end)

RegisterNetEvent("laundryexit")
AddEventHandler("laundryexit", function()
    SetEntityCoords(PlayerPedId(), 951.35, -1711.9, 30.93)
    SetEntityHeading(PlayerPedId(), 91.11) 
    DoScreenFadeIn(1000)
    Citizen.Wait(1000)
end)