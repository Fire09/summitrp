...
-- simple localization
Config.Language = {
    joining = "\xF0\x9F\x8E\x89Joining SRP...",
    connecting = "\xE2\x8F\xB3Connecting to SRP...",
    ...
    wlonly = "\xE2\x9D\x97[SRPQueue] You must be whitelisted to join this server. To apply, head to : Link coming soon",
