...
function cmd.RunCommand(caller, args)
    ...
    exports["srp-log"]:AddLog("Admin", caller, "Spawned car", {car = tostring(args.message)}) 
    SRP.Admin:Log(log, caller)
end
...
function cmd.RunCommand(caller, args)
    ...
    exports["srp-log"]:AddLog("Admin", caller, "Spawned item", {item = tostring(args.message),amount = tostring(args.amount)}) 
    SRP.Admin:Log(log, caller)
end
...
function cmd.RunCommand(caller, args)
    ...
    exports["srp-log"]:AddLog("Admin", caller, "Changed weather/time/Cycle", {time = args.time, weather = args.weather, light = args.light, blackout = args.blackout}) 
...
function cmd.RunCommand(caller, args)
    ...
    exports["srp-log"]:AddLog("Admin", caller, "Set Model", {item = tostring(args.message)}) 
    SRP.Admin:Log(log, caller)
end
