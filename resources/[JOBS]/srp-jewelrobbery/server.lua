...
AddEventHandler('srp-jewelrobbery:AwardItems', function()
	...
	if math.random(7) == 1 then
		TriggerClientEvent("player:receiveItem", src, "rolexwatch",math.random(4,8))
    end
    if math.random(9) == 1 then
		TriggerClientEvent("player:receiveItem", src, "rolexwatch",math.random(1,1))
    end

    if math.random(2) == 1 then
		TriggerClientEvent("player:receiveItem", src, "rolexwatch",math.random(1,8))
    end

    if math.random(3) == 1 then
		TriggerClientEvent("player:receiveItem", src, "rolexwatch",math.random(1,6))
    end

    if math.random(2) == 1 then
		TriggerClientEvent("player:receiveItem", src, "rolexwatch",math.random(1,10))
    end
    
    if math.random(1) == 1 then
		TriggerClientEvent("player:receiveItem", src, "rolexwatch",math.random(1,5))
    end
