...
AddEventHandler("sellfish", function()
    if not DoingTask2 then
        DoingTask2 = true
        if exports["srp-inventory"]:hasEnoughOfItem("fish",5,false) then 
            local finished = exports["srp-taskbar"]:taskBar(4000,"Selling Fish")
            if finished == 100 then
                local sushi = math.random(200, 500)
                DoingTask2 = false
...
-- Blips
local blips = {
 ---   {title="Fishing Pier", colour=62, id=410, scale=0.7, x = 1302.8814453125, y = 4230.94719238281, z = 33.9166892242432},
---    {title="Fish Process", colour=0, id=525, scale=0.5, x = 912.1876074219, y = 3659.28708740234, z = 32.579754676819},
    {title="Sell Fish", colour=9, id=93, scale=0.7, x = -1037.6729736328, y = -1397.1528320312, z = 5.5531921386719}
}
