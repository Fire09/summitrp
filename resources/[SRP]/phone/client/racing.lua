...
RegisterNUICallback('racing:events:list', function()
  if (exports["srp-inventory"]:hasEnoughOfItem("racingdongle", 1) or exports["srp-inventory"]:hasEnoughOfItem("createrace", 1, true)) then
      if exports["srp-inventory"]:hasEnoughOfItem("racingdongle", 1) then
          SendNUIMessage({
