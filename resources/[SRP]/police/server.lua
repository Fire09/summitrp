...
RegisterServerEvent('tcheckLicensePlate')
				...
				exports.ghmattimysql:execute('SELECT * FROM characters WHERE `id` = @cid', { ['@cid'] = result[1].cid }, function(data)
					exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE `owner` = @cid', { ['@cid'] = data[1].id }, function(penis)
						if penis[1] ~= nil then
							...
							TriggerClientEvent("chatMessage", source, "DISPATCH", 3, "10-74 (Negative) Name: " .. data[1].first_name .. " " .. data[1].last_name .. " Phone_number: " .. phoneNumber .. ' Job: ' .. job)
							TriggerClientEvent('InteractSound_CL:PlayOnOne', source, 'radioclick', 1.0)
						else
							TriggerClientEvent("chatMessage", source, "DISPATCH", 3, "10-74 (Negative) Name: " .. data[1].first_name .. " " .. data[1].last_name .. " Phone_number: " .. phoneNumber .. ' Job: Unemployed')
							TriggerClientEvent('InteractSound_CL:PlayOnOne', source, 'radioclick', 1.0)
						end
					end)
				end)
