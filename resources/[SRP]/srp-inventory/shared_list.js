...
itemList['spikes'] = {
  ...
  model: '',
  image: 'np_spikes.png',
  information: 'Considered Police Equipment - (only lasts around 5 seconds)',
};
...
itemList['joint'] = {
  ...
  craft: [[
    { itemid: 'weedq', amount: 2.0 },
    { itemid: 'rollingpaper', amount: 5 },
  ]],
  price: 25,
  weight: 2,
  nonStack: false,
...
itemList['petrol'] = {     
  ...
  model:'',
  image: 'np_oil.png',
  information: 'Used to produce the good good',
  deg: false,   
};
...
itemList['cocaleafs'] = {
  fullyDegrades: true,
  decayrate: 1.3,
  displayname: 'Coca Leafs',
  price: 1,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'srp-cocaleaf.png',
  information: 'Used to produce Cocaine',
  deg: false,
};
