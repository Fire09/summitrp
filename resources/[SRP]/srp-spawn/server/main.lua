...
AddEventHandler("backpack:give:items", function()
    ...
    TriggerClientEvent("player:receiveItem", src, "lockpick", 1)
    TriggerClientEvent("player:receiveItem", src, "repairkit", 1)
    TriggerClientEvent("player:receiveItem", src, "lsdtab", 1)
end)
