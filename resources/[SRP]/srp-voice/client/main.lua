...
RegisterNetEvent('srp-voice:SetRadioVolume')
AddEventHandler('srp-voice:SetRadioVolume', function(passedRadioVolume)
	volume = passedRadioVolume
end)

RegisterNetEvent('srp-voice:updateRoutingBucket')
AddEventHandler('srp-voice:updateRoutingBucket', function(routingBucket)
...
RegisterNetEvent('srp-voice:mutePlayer')
AddEventHandler('srp-voice:mutePlayer', function()
...
RegisterCommand('vsync', function()
	local newGrid = getGridZone()
	debug(('[srp-voice] [vsync] Forcing zone from %s to %s and adding nearby grids.'):format(currentGrid, newGrid))
...
AddEventHandler('onClientResourceStart', function(resource)
	...
	print('[srp-voice] Intitalized voices.')
	intialized = true
...
RegisterCommand("grid", function()
	print(('[srp-voice] Players current grid is %s'):format(currentGrid))
end)